...
set_target_properties(octomath PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liboctomath.so.1.9.0"
  IMPORTED_SONAME_RELEASE "liboctomath.so.1.9"
  )

list(APPEND _IMPORT_CHECK_TARGETS octomath )
list(APPEND _IMPORT_CHECK_FILES_FOR_octomath "${_IMPORT_PREFIX}/lib/liboctomath.so.1.9.0" )
...
set_target_properties(octomap PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/usr/lib/x86_64-linux-gnu;octomath"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liboctomap.so.1.9.0"
  IMPORTED_SONAME_RELEASE "liboctomap.so.1.9"
  )

list(APPEND _IMPORT_CHECK_TARGETS octomap )
list(APPEND _IMPORT_CHECK_FILES_FOR_octomap "${_IMPORT_PREFIX}/lib/liboctomap.so.1.9.0" )
...
set_target_properties(octomap-static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/usr/lib/x86_64-linux-gnu"
