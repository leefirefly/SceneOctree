...
class Waypoint(genpy.Message):
  _md5sum = "880c6386c7dde0364a7b70d611f6e26f"
...
"""
  __slots__ = ['w','chi_d','chi_valid','Va_d','set_current','clear_wp_list','priority','loiter_point','landing']
  _slot_types = ['float32[3]','float32','bool','float32','bool','bool','int8','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       w,chi_d,chi_valid,Va_d,set_current,clear_wp_list,priority,loiter_point,landing
    ...
    if args or kwds:
      ...
      if self.priority is None:
        self.priority = 0
      if self.loiter_point is None:
        self.loiter_point = False
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_fBf2Bb2B().pack(_x.chi_d, _x.chi_valid, _x.Va_d, _x.set_current, _x.clear_wp_list, _x.priority, _x.loiter_point, _x.landing))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.chi_d, _x.chi_valid, _x.Va_d, _x.set_current, _x.clear_wp_list, _x.priority, _x.loiter_point, _x.landing,) = _get_struct_fBf2Bb2B().unpack(str[start:end])
      self.chi_valid = bool(self.chi_valid)
      self.set_current = bool(self.set_current)
      self.clear_wp_list = bool(self.clear_wp_list)
      self.loiter_point = bool(self.loiter_point)
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_fBf2Bb2B = None
def _get_struct_fBf2Bb2B():
    global _struct_fBf2Bb2B
    if _struct_fBf2Bb2B is None:
        _struct_fBf2Bb2B = struct.Struct("<fBf2Bb2B")
    return _struct_fBf2Bb2B
_struct_3f = None
def _get_struct_3f():
    global _struct_3f
