...
class Waypoint {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('loiter_point')) {
        this.loiter_point = initObj.loiter_point
      }
      else {
        this.loiter_point = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [loiter_point]
    bufferOffset = _serializer.bool(obj.loiter_point, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [loiter_point]
    data.loiter_point = _deserializer.bool(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '880c6386c7dde0364a7b70d611f6e26f';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.loiter_point !== undefined) {
      resolved.loiter_point = msg.loiter_point;
    }
    else {
      resolved.loiter_point = false
    }
