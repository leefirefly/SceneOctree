...
(cl:defmethod priority-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplane_msgs-msg:priority-val is deprecated.  Use rosplane_msgs-msg:priority instead.")
  (priority m))

(cl:ensure-generic-function 'loiter_point-val :lambda-list '(m))
(cl:defmethod loiter_point-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplane_msgs-msg:loiter_point-val is deprecated.  Use rosplane_msgs-msg:loiter_point instead.")
  (loiter_point m))

(cl:ensure-generic-function 'landing-val :lambda-list '(m))
(cl:defmethod landing-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplane_msgs-msg:landing-val is deprecated.  Use rosplane_msgs-msg:landing instead.")
  (landing m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Waypoint>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'loiter_point) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Waypoint>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'w)))
    ...
    (cl:setf (cl:slot-value msg 'loiter_point) (cl:not (cl:zerop (cl:read-byte istream))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Waypoint>)))
  ...
  "880c6386c7dde0364a7b70d611f6e26f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Waypoint)))
  "Returns md5sum for a message object of type 'Waypoint"
  "880c6386c7dde0364a7b70d611f6e26f")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Waypoint>))
  ...
  (cl:list 'Waypoint
    ...
    (cl:cons ':loiter_point (loiter_point msg))
