...
(cl:defmethod cl:initialize-instance :after ((m <Path>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosplane_msgs-msg:<Path> is deprecated: use rosplane_msgs-msg:Path instead.")))
...
(cl:defmethod poses-val ((m <Path>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplane_msgs-msg:poses-val is deprecated.  Use rosplane_msgs-msg:poses instead.")
  (poses m))
