...
"""autogenerated by genpy from abstract_msgs/EventResult.msg. Do not edit."""
import sys
...
class EventResult(genpy.Message):
  _md5sum = "cc2ad38104a65a7df727d5b4baeb7e4a"
  _type = "abstract_msgs/EventResult"
...
float64 w
"""
  __slots__ = ['senderID','receiverID','layerName','sceneName','data','eventCount']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       senderID,receiverID,layerName,sceneName,data,eventCount
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.eventCount))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.eventCount,) = _get_struct_i().unpack(str[start:end])
      return self
