...
struct Waypoint_
{
  ...
  _priority_type priority;
   ...
   typedef uint8_t _loiter_point_type;
  _loiter_point_type loiter_point;
...
struct MD5Sum< ::rosplane_msgs::Waypoint_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x880c6386c7dde036ULL;
  static const uint64_t static_value2 = 0x4a7b70d611f6e26fULL;
};
...
struct Printer< ::rosplane_msgs::Waypoint_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosplane_msgs::Waypoint_<ContainerAllocator>& v)
  {
    ...
    s << indent << "loiter_point: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.loiter_point);
    s << indent << "landing: ";
